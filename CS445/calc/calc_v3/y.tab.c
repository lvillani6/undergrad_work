...
{
  "$end", "error", "$undefined", "EOS", "NUM", "ADDOP", "MULOP", "'\\n'",
...
#line 35 "calc.y" /* yacc.c:1646  */
    { (yyval.tval) = make_tree( NUM, NULL, NULL); (yyval.tval)->attribute.ival = (yyvsp[0].ival); }
